...
struct WritableMap : jni::JavaClass<WritableMap> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/WritableMap;";
};

struct WritableNativeMap : jni::HybridClass<WritableNativeMap, ReadableNativeMap> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/WritableNativeMap;";
