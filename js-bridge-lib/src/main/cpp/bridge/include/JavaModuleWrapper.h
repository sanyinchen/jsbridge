...
struct JMethodDescriptor : public jni::JavaClass<JMethodDescriptor> {
  static constexpr auto kJavaDescriptor =
    "Lcom/sanyinchen/jsbridge/module/impl/java/JavaModuleWrapper$MethodDescriptor;";
...
struct JavaModuleWrapper : jni::JavaClass<JavaModuleWrapper> {
  static constexpr auto kJavaDescriptor = "Lcom/sanyinchen/jsbridge/module/impl/java/JavaModuleWrapper;";
