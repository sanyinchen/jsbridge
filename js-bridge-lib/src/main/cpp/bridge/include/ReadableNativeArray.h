...
struct ReadableArray : jni::JavaClass<ReadableArray> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/ReadableArray;";
};
...
class ReadableNativeArray : public jni::HybridClass<ReadableNativeArray, NativeArray> {
 ...
 public:
  static constexpr const char* kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/ReadableNativeArray;";
