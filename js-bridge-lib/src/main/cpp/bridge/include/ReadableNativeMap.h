...
struct ReadableMap : jni::JavaClass<ReadableMap> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/ReadableMap;";
};

struct ReadableNativeMap : jni::HybridClass<ReadableNativeMap, NativeMap> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/ReadableNativeMap;";
...
struct ReadableNativeMapKeySetIterator : jni::HybridClass<ReadableNativeMapKeySetIterator> {
  static auto constexpr kJavaDescriptor = "Lcom/sanyinchen/jsbridge/data/ReadableNativeMap$ReadableNativeMapKeySetIterator;";
