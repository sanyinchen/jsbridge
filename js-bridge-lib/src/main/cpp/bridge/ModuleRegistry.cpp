...
namespace facebook {
    namespace react {
                    ...
                    for (size_t index = modulesSize; index < modulesSize + addModulesSize; index++) {
                        ...
                        if (it != unknownModules_.end()) {
                            throw std::runtime_error(
                                    folly::to<std::string>("module ", name,
        ...
        void ModuleRegistry::callNativeMethod(unsigned int moduleId, unsigned int methodId, folly::dynamic &&params,
                                              int callId) {
        ...
        MethodCallResult ModuleRegistry::callSerializableNativeHook(unsigned int moduleId, unsigned int methodId,
